 ...
 */
@WebServlet("/ViewMatchRequestByUserServlet")
public class ViewMatchRequestByUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewMatchRequestByUserServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<MatchRequest> matchRequestList = msg.listMatchRequestsbyUserId(uid);
		
		request.setAttribute("matchRequestList", matchRequestList);
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ViewMatchRequestByUser.jsp");
