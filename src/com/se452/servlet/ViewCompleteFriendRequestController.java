...
/**
 * Servlet implementation class ViewCompleteFriendRequestController
 */
@WebServlet("/ViewCompleteFriendRequestController")
public class ViewCompleteFriendRequestController extends HttpServlet {
     ...
     */
    public ViewCompleteFriendRequestController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("ViewCompleteFriendRequestReveived.jsp");
